...
def browse_products(
    ...
    sort_by: str = Query('price', patttern="^(price|name)$", description="Sort by 'price' or 'name'"),
    order: str = Query('asc', pattern="^(asc|desc)$", description="'asc' for low-to-high, 'desc' for high-to-low"),
